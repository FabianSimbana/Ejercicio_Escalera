...
AutÛmata Finito Determinista - ADF

Un autÛmata finito determinista es una quÌntupla que denotaremos de manera genÈrica por M=(Q,?,q0,?,F), donde:
- Q       es un conjunto finito cuyos elementos llamaremos estados. 
- ?       es un alfabeto que llamamos alfabeto de entrada. 
- q0?Q    es un estado seÒalado que llamamos estado inicial. 
- F       es un subconjunto de Q no vacÌo, cuyos elementos llamamos estados finales. 
- ?       es una aplicaciÛn de Q◊??Q , que llamamos funciÛn de transiciÛn. 

por ejemplo:
Tenemos un alfabeto ? = {a, b, c}, entonces en la matriz de transiciÛn tomara la letra 'a' como indice 0 , letra 'b' indice 1 y letra 'c' indice 2.
