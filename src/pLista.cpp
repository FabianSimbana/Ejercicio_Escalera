 ...
 * DEBER:
    ...
    tarea  
    lista simple                                                       Grupo
    insertarElemento(lista, _dato, pos); antes y despues            1
    reportarLista(lista);                                           2
    buscarElemento(lista, _dato);                                   3
    eliminarElemento(lista, _dato);                                 4
    eliminaRepetidos(lista, _dato);                                 5
